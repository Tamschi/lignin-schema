...
[bugs]: https://github.com/Tamschi/lignin-schema/issues/new?assignees=&labels=bug&template=bug_report.md&title=
[feature requests]: https://github.com/Tamschi/lignin-schema/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=
["Custom issue"]: https://github.com/Tamschi/lignin-schema/issues/new?assignees=&labels=&template=custom_issue.md&title=
...
See <https://github.com/Tamschi/lignin-schema/issues/labels> for details on individual labels.

### Categories

- Assorted

  Labels without prefix like [`breaking`](https://github.com/Tamschi/lignin-schema/labels/breaking),
  [`good first issue`](https://github.com/Tamschi/lignin-schema/labels/good%20first%20issue) or
  [`help wanted`](https://github.com/Tamschi/lignin-schema/labels/help%20wanted).
